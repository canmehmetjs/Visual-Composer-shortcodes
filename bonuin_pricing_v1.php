<?php
add_shortcode( 'bonuin_pricing_v1', 'initialize_bonuin_pricing_v1' );
function initialize_bonuin_pricing_v1( $atts ) {
...
<div class="bonuin_pricing_shortcode_v1">
	...
	<?php 
		...
		while ( $loop->have_posts() ) : $loop->the_post();
			...
			switch ($package_duration){
				case 'monthly':
					$duration = __('Monthly','bonuin_theme');
				break;
				case 'yearly':
					$duration = __('Yearly','bonuin_theme');
				break;
			}
				...
				<div class="pricing_item">
					...
					<?php if ($display_button == 'yes') {?>
						<div class="pricing_button">
							<a href="<?php echo esc_attr($button_url);?>" class="btn btn_circle green_outline"><?php echo esc_attr($button_placeholder);?></a>
						</div>
					<?php } ?>
